...
PARAMS=" --grid NL.NL.NL.NT --mpi 2.2.1.1 --threads 20 --accelerator-threads 4 ${OPTIONS} --ParameterFile ${XML}"
lrun -M -gpu -N 1 -n 4 $APP $PARAMS >& log.lrun.JOBNAME_cont${lasttraj}
