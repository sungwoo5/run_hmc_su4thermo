...
dat=sorted(np.genfromtxt("fullnodelist_used.txt",dtype=int).flatten())
print(dat)
# exit(1)
...
plt.title("Node usage count in 6044 jobs 10/07/24--10/24/24 on Tuolumne\n (Grid SU(4) MDWF HMC $24^3x12$, $24^3x8$, $32^3x8$ jobs)", fontsize=10)
ax.text(-0.42, -0.1, 'ALL SUCCESS\nNO FAILURE FOUND', color='red', fontsize=14, ha='left', transform=ax.transAxes)

plt.savefig("nodeusage_run100724_102424.pdf")
plt.clf()
