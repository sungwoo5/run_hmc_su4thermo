...
# dirlist=("conf_nc4nf1_328_b10p81c_m0p1000"
# 	 "conf_nc4nf1_328_b10p81_m0p1000"
# 	 "conf_nc4nf1_328_b10p83c_m0p1000"
# 	 "conf_nc4nf1_328_b10p83_m0p1000"
# 	 "conf_nc4nf1_328_b10p84c_m0p1000"
# 	 "conf_nc4nf1_328_b10p84_m0p1000"
# 	 "conf_nc4nf1_328_b10p86c_m0p1000"
# 	 "conf_nc4nf1_328_b10p86_m0p1000"
# 	 )
#dirlist=($(ls -d conf_nc4nf1_248_b11p0[0-9]*_m0p4000 conf_nc4nf1_248_b1*_m0p1000 ))
#dirlist=($(ls -d conf_nc4nf1_248_b10p8*_m0p1000 ))
#dirlist=($(ls -d conf_nc4nf1_248_b10p8[3467]*_m0p1000 conf_nc4nf1_248_b11p0[1-4]*_m0p4000))
dirlist=($(ls -d conf_nc4nf1_248_b11p0[2-5]*_m0p4000 conf_nc4nf1_248_b10p84_m0p1000))
...
while true; do
	...
	if [ ! -e "$JOB1" ]; then
	    ...
	    echo $d
	    if [ ! -e "$JOB0" ]; then
		# cmd="flux batch --queue=pbatch  --job-name=${label}_cont ../fluxauto_cont_248_N2.sh > ${JOB0}"
		# cmd="flux batch --queue=pdebug  --job-name=${label}_cont ../fluxauto_cont_248_N2.sh > ${JOB0}"
		# cmd="flux batch --queue=pbatch --requires=-host:tuolumne1079 --job-name=${label}_cont ../fluxauto_cont_248_N2.sh > ${JOB0}"
		cmd="flux batch --queue=pbatch --requires=-host:tuolumne1079 --job-name=${label}_cont ../fluxauto_cont_248_N4.sh > ${JOB0}"
		echo ${cmd}
		eval ${cmd}
	    fi
		...
		# R: running
		# cmd="flux batch --queue=pdebug --job-name=${label}_cont --dependency=afterany:$(cat $JOB0) ../fluxauto_cont_248_N2.sh > ${JOB1}"
		# cmd="flux batch --queue=pbatch --requires=-host:tuolumne1079 --job-name=${label}_cont --dependency=afterany:$(cat $JOB0) ../fluxauto_cont_248_N2.sh > ${JOB1}"
		cmd="flux batch --queue=pbatch --requires=-host:tuolumne1079 --job-name=${label}_cont --dependency=afterany:$(cat $JOB0) ../fluxauto_cont_248_N4.sh > ${JOB1}"
		echo ${cmd}
		eval ${cmd}
